export const questions = [
  {
    "id": "GQ1",
    "category": { "en": "Geography", "np": "भूगोल" },
  ...
  },
  {
    ...
    "relatedTo": "C2",
    "relatedText": { "en": "Links to Red Meat Frequency (C2)", "np": "रातो मासुको आवृत्ति (C2) सँग सम्बन्धित" },
    "options": [
  ...
  },
  {
    ...
    "relatedTo": "C6",
    "relatedText": { "en": "Links to Livestock Ownership (C6)", "np": "पशुपालन (C6) सँग सम्बन्धित" },
    "options": [
  ...
  },
  {
    ...
    "relatedTo": "C2",
    "relatedText": { "en": "Links to Red Meat Diet (C2)", "np": "रातो मासुको आहार (C2) सँग सम्बन्धित" },
    "options": [
  ...
  },
  {
    ...
    "relatedTo": "C3",
    "relatedText": { "en": "Links to Food Waste (C3)", "np": "खाद्य फोहोर (C3) सँग सम्बन्धित" },
    "options": [
